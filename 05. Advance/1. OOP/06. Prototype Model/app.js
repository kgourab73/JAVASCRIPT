...
const kirti = new Person("kirti", "WebDev", "JavaScript");
console.log(kirti);
console.log(kirti.__proto__);
console.log(kirti.__proto__.__proto__);
console.log(kirti.__proto__.__proto__.__proto__);
